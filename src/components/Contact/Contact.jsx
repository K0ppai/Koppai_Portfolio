...
const Contact = ({ darkMode }) => {
  return (
    <section
      className="bg-secondary_pale_light px-4 pb-20 pt-10 dark:bg-bg_card_dark dark:text-secondary_pale_light"
      id="contact"
    >
      ...
      >
        ...
        <button
          ...
          } font-semibold rounded-full bg-secondary_light py-4 dark:bg-secondary_dark`}
        >
          Get In Touch
        </button>
      </form>
